<template>
    <layout :hasHeaderSearch="true" @end-scroll="handleInfiniteScroll" @handleHeaderSearch="handleMobileSearch"
        :search="search">
        <!-- For MOBILE - START -->
        ...
        <template v-if="useMq().current === 'xs'">
            <el-row class="text-center" style="margin-bottom: 20px">
                <el-button v-if="permission.w_disposisi" @click="handleAddDisposisi" icon="el-icon-circle-plus-outline"
                    type="primary">Tambah Disposisi</el-button>
            </el-row>
            <el-row>
                <filter-container :options="filterOption" :query="query.filterQuery" @submit="handleFilterSubmitted"
                    @deleted="handleFilterDeleted"></filter-container>
            </el-row>
            <el-row v-if="Array.isArray(tableDataMobile) && tableDataMobile.length > 0">
                <el-table :data="tableDataMobile" style="width: 100%" @row-click="handleActionMobileState">
                    ...
                    <el-table-column width="130" label="No. Disposisi" prop="no_disposisi">
                    </el-table-column>
            ...
            <el-row v-else class="no-result">
                <el-result title="Data Tidak Ditemukan"
        ...
        <template v-else>
            <el-row type="flex" class="width-100">
                <el-col :span="18">
                    <el-form @submit.prevent="handleSearch">
                        ...
                        <el-row type="flex" align="center" :gutter="40">
                            <el-col :span="18">
                                <el-form-item>
                                    <el-input placeholder="Cari Disposisi Masuk" prefix-icon="el-icon-search"
                                        v-model="search">
                                    </el-input>
                                </el-form-item>
                            </el-col>
                ...
                <el-col :offset="1" :span="5" class="text-center">
                    <el-button v-if="permission.w_disposisi" @click="handleAddDisposisi"
                        icon="el-icon-circle-plus-outline" type="primary">Tambah Disposisi</el-button>
                </el-col>
            </el-row>
            <el-row>
                <filter-container :options="filterOption" :query="query.filterQuery" @submit="handleFilterSubmitted"
            ...
            <el-row>
                <template v-if="Array.isArray(tableData) && tableData.length > 0">
                    <el-col>
                        <el-table @sort-change="handleSortTable" :data="tableData" :default-sort="q_sort"
                            style="width: 100%">
                            <el-table-column label="Tenggat Waktu" width="190" prop="tenggat_waktu" sortable="custom">
                                <template #default="scope">
                                    {{
                            ...
                            <el-table-column prop="no_disposisi" sortable="custom" label="No. Disposisi" width="150">
                            </el-table-column>
                            <el-table-column prop="status" sortable="custom" label="Status" width="150">
                            </el-table-column>
                            <el-table-column prop="tanggal_ubah" sortable="custom" label="Terakhir Diubah" width="170">
                                <template #default="scope">
                                    {{
                            ...
                            <el-table-column prop="asal" label="Asal" sortable="custom" width="150"></el-table-column>
                            <el-table-column sortable="custom" prop="tujuan" label="Tujuan" width="160">
                            </el-table-column>
                            ...
                            <el-table-column fixed="right" label="Aksi" width="200">
                                <template #default="scope">
                                    <el-button size="mini" @click="handleDetailTable(scope.row.id)">Detail</el-button>
                                    <template v-if="canDelete()">
                                        <el-popconfirm title="Apakah anda yakin menghapus disposisi ini?"
                    ...
                    <el-col class="text-center" style="margin-top: 30px">
                        <el-pagination @current-change="handlePageClick" @prev-click="handlePageClick"
                            @next-click="handlePageClick" :current-page="_pagination.currentPage"
                            :page-count="_pagination.lastPage" background :total="totalPage"></el-pagination>
                    </el-col>
                        ...
                        <el-row>
                            <el-col :span="12">
                                <p>
                                    ...
                                    <small class="text-muted" v-if="_pagination.total > 100">Kami membatasi halaman
                                        tabel hingga
        ...
        <el-dialog title="Aksi" v-model="actionDialogVisible" width="80%" center>
            <el-space :fill="true" alignment="center" style="width: 100%">
                <el-button style="width: 100%" @click="handleDetailTable()" type="primary">Lihat Detail</el-button>
                <template v-if="canDelete()">
                    <el-popconfirm title="Apakah anda yakin menghapus disposisi ini?" confirmButtonText="Iya"
                        cancelButtonText="Tidak" @confirm="handleDeleteDisposisi()">
                        <template #reference>
                            <el-button style="width: 100%" type="danger">Hapus</el-button>
                        </template>
                    </el-popconfirm>
                </template>
                <el-button style="width: 100%" @click="actionDialogVisible = false">Tutup</el-button>
            </el-space>
        </el-dialog>
        <!-- For PC - END -->
    </layout>
