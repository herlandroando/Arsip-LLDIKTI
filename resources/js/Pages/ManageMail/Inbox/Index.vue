    ...
    <layout :hasHeaderSearch="true" @end-scroll="handleInfiniteScroll" @handleHeaderSearch="handleMobileSearch"
        ...
        <template v-if="useMq().current === 'xs'">
            <el-row class="text-center" style="margin-bottom: 20px">
                <el-button v-if="permission.w_suratmasuk" @click="handleAddMail" icon="el-icon-circle-plus-outline"
                    type="primary">Tambah Surat</el-button>
            </el-row>
            <el-row>
                ...
                <el-col :span="18">
                    <el-form @submit.prevent="handleSearch">
                        ...
                        <el-row type="flex" align="center" :gutter="40">
                            <el-col :span="18">
                                <el-form-item>
                                    <el-input placeholder="Cari Surat Masuk" prefix-icon="el-icon-search"
                                        v-model="search">
                                    </el-input>
                                </el-form-item>
                            </el-col>
                ...
                <template v-if="Array.isArray(tableData) && tableData.length > 0">
                    <el-col>
                        <el-table @sort-change="handleSortTable" :data="tableData" :default-sort="q_sort"
                            style="width: 100%">
                            <el-table-column label="Tanggal Surat" width="250" prop="tanggal_surat" sortable="custom">
                                <template #default="scope">
                                    {{
                                            new Date(scope.row.tanggal_surat).toLocaleString("id-ID", {
                                                dateStyle: "full",
                            ...
                            <el-table-column prop="sifat" sortable="custom" label="Sifat Surat" width="150">
                            </el-table-column>
                            <el-table-column prop="no_surat" sortable="custom" label="No. Surat" width="150">
                            </el-table-column>
                            <el-table-column prop="asal_surat" sortable="custom" label="Asal Surat" width="150">
                            </el-table-column>
                            ...
                            <el-table-column fixed="right" label="Aksi" width="200">
                                <template #default="scope">
                                    ...
                                    <template v-if="canDelete(scope.row)">
                                        ...
                                        " confirmButtonText="Iya" cancelButtonText="Tidak" @confirm="handleDeleteMail(scope.row.id)">
                                            <template #reference>
                ...
                <template v-if="canDelete(false)">
                    <el-popconfirm :title="
                        !deleteNotPermanent
                            ? 'Apakah anda yakin menghapus surat ini? (Surat akan terhapus selamanya!)'
                            : 'Apakah anda yakin menghapus surat ini?'
                    " confirmButtonText="Iya" cancelButtonText="Tidak" @confirm="handleDeleteMail()">
                        <template #reference>
