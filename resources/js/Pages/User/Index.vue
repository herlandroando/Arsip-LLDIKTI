<template>
  ...
  >
    ...
    <template v-else>
      ...
      <el-divider content-position="left">Tabel Pengguna</el-divider>
      <el-row>
...
export default {
  ...
  setup(props) {
    ...
    function handleFilterSubmitted(v) {
      ...
      Inertia.get(route("setting.users.index"), {
        search: search.value,
        ...query.filterQuery,
        sort: query.sort,
      });
    ...
    async function handleInfiniteScroll() {
      ...
      await axios
        .get(route("setting.users.index.json"), {
          params: {
            search: search.value,
