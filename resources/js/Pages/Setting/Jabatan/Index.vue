<template>
    <layout>
        <el-row :gutter="30">
            <el-col :span="24" :md="8">
                <el-card class="box-card jabatan-container" :class="{ 'has-content': isAvailable }">
                    ...
                    <div class="jabatan-footer-bar">
                        ...
                        <el-button v-else :disabled="unableChange" @click="handleAddList" type="primary"><b>Tambah</b>
                        </el-button>
                    </div>
                </el-card>
            </el-col>
                            ...
                            <el-row class="form-container">
                                <el-col v-if="isAdd" :span="24" prop="nama">
                                    <el-form-item label="Nama Jabatan">
                                        ...
                                        <small class="text-muted">Nama dari jabatan yang diberikan minimal 3 karakter
                                            huruf.</small>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="24" prop="ijin">
                                    <el-form-item label="Ijin yang Digunakan">
                                        <el-select v-model="formData.ijin" placeholder="Pilih salah satu"
                                            :disabled="unableChange">
                                            <el-option v-for="item in permissionList" :key="item.id" :label="item.nama"
                                                :value="item.id">
                                            </el-option>
                                        </el-select>
                                    </el-form-item>
        ...
        <el-dialog @close="handleCancelList" v-if="useMq().current === 'sm' || useMq().current === 'xs'"
            v-model="isDialogFormOpened" :title="isAdd ? 'Tambah Jabatan' : 'Ubah Jabatan'" width="90%">
            <el-form label-position="top" label-width="100px" :model="formData" ref="form">
                <el-row class="form-container">
                    <el-col v-if="isAdd" :span="24" prop="nama">
                        <el-form-item label="Nama Jabatan">
            ...
            <template #footer>
                <el-button v-if="!unableChange" @click="handleSubmit" :disabled="!isEdit && !isAdd || unableChange"
                    type="primary">
                    Simpan
                </el-button>
        ...
        <el-dialog v-model="isDialogWarnOpened" title="Peringatan" width="50%">
            ...
            <small class="text-error">Pengguna yang memakai jabatan ini akan terubah menjadi tidak ada
